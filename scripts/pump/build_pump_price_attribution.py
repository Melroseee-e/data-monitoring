...
REPORT_PATH = PUMP_DIR / 'reports' / 'pump_price_attribution_report.md'
FULL_REPORT_PATH = PUMP_DIR / 'reports' / 'pump_price_attribution_full_report.md'
OUTPUT_PATH = PUMP_DIR / 'core' / 'pump_price_attribution.json'

BEHAVIOR_PATH = PUMP_DIR / 'derived' / 'pump_behavior_chart_data.json'
WHALE_ANALYSIS_PATH = PUMP_DIR / 'core' / 'pump_whale_analysis.json'
WHALE_CHART_PATH = PUMP_DIR / 'derived' / 'pump_whale_chart_data.json'
BUYBACK_ANALYSIS_PATH = PUMP_DIR / 'core' / 'pump_buyback_analysis.json'
BUYBACK_RECON_PATH = PUMP_DIR / 'derived' / 'pump_buyback_source_reconciliation.json'
ADDRESSES_PATH = PUMP_DIR / 'core' / 'pump_addresses.json'
TEAM_ANALYSIS_PATH = PUMP_DIR / 'core' / 'pump_team_analysis.json'
FORENSIC_REPORT_PATH = PUMP_DIR / 'reports' / 'pump_buyback_forensic_report.md'
